...
use vulkano::{
    ...
    memory::{
        ...
        DedicatedAllocation, DeviceMemory, MemoryAllocateInfo, MemoryRequirements, ResourceMemory,
    },
    Validated,
};
...
impl DeviceExt for Device {
    fn new_image(
        ...
        let resource_memory =
            allocate_dedicated(self.clone(), DedicatedAllocation::Image(&raw_image), filter)
    ...
    fn new_buffer(
        ...
        let resource_memory =
            allocate_dedicated(self.clone(), DedicatedAllocation::Buffer(&buffer), filter)
